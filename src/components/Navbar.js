...
const Navbar = ({ theme, toggleTheme }) => {
  ...
  // Define the links to be used in both desktop and mobile menus
  const navLinks = [
    { to: "/", text: "Home" },
  ...
  return (
    <nav className="bg-background-primary/80 backdrop-blur-sm sticky top-0 z-50 shadow-md border-b border-border-color">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="-mr-2 flex md:hidden">
            ...
            <button
              ...
              type="button"
              className="bg-background-secondary inline-flex items-center justify-center p-2 rounded-md text-text-secondary hover:text-text-primary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-background-secondary focus:ring-accent-primary"
      ...
      {isOpen && (
        <div className="md:hidden border-t border-border-color" id="mobile-menu">
