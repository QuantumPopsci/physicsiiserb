            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {resources.videos.map((video, index) => (
                <div key={index} className="bg-gray-800/50 rounded-lg overflow-hidden border border-gray-700">
                  {/* This is the new method for controlling the aspect ratio.
                    'relative' creates a positioning context.
                    'pt-[75%]' sets the height to 75% of the width, creating a 4:3 ratio.
                  */}
                  <div className="relative pt-[75%]">
                    <iframe
                      ...
                      allowFullScreen
                      // This makes the iframe fill the container we just sized.
